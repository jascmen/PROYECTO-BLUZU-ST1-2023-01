...
let productoHtml = '<div class="col-md-6 col-lg-4"> <div class="card text-center card-product"><div class="card-product__img"><img class="card-img" src="/productos/'
                    + producto.img_prod +'" alt=""><ul class="card-product__imgOverlay"><li><a href="producto.html?id_producto='+ producto.idProd +'"><button><i class="ti-search"></i></button></a></li></ul> </div><div class="card-body"><p>'
